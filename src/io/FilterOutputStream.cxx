...
void FilterOutputStream::write(uint8_t b) throw (IOException)
{
	out.write(b);
}

void FilterOutputStream::write(const uint8_t* data, size_t offset, size_t len) throw (IOException)
{
	out.write(data, offset, len);
}

void FilterOutputStream::write(const array<uint8_t>& b) throw (IOException)
{
