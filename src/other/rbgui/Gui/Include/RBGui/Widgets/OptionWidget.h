...
#ifndef GUI_OPTIONWIDGET_H
#define GUI_OPTIONWIDGET_H
...
/// An option/radio button widget
class GUI_EXPORT OptionWidget : public Widget
{
protected:
	Mocha::Color mColor;
...
public:
	OptionWidget( GuiManager* vManager );
	...
	/// Gets whether or not the option is selected
