...
#ifndef GUI_BOOLATTRIBUTEWIDGET_H
#define GUI_BOOLATTRIBUTEWIDGET_H
...
//--------------------------------
class BoolAttributeWidget : public AttributeWidget
{
private:
	DropListWidget* mList;

	void listChanged( GuiElement& vElement, const Mocha::ValueList& vValues );

protected:
	virtual void onRectangleChanged( );

public:
	BoolAttributeWidget( GuiManager* vManager );

	virtual ~BoolAttributeWidget( );
