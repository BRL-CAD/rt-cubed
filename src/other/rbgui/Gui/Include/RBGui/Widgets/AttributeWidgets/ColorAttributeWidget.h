...
#ifndef GUI_COLORATTRIBUTEWIDGET_H
#define GUI_COLORATTRIBUTEWIDGET_H
...
{
private:
	ColorSelectWidget* mSelector;

	void colorChanged( GuiElement& vElement, const Mocha::ValueList& vValues );

protected:
	virtual void onRectangleChanged( );

public:
	ColorAttributeWidget( GuiManager* vManager );

	virtual ~ColorAttributeWidget( );
