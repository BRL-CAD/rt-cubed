...
#ifndef GUI_BUTTONATTRIBUTEWIDGET_H
#define GUI_BUTTONATTRIBUTEWIDGET_H
...
class ButtonAttributeWidget : public AttributeWidget
{
private:
...
public:
	ButtonAttributeWidget( GuiManager* vManager );

	virtual ~ButtonAttributeWidget( );

	virtual void setAttribute( const Mocha::Value& vValue );

	virtual void setOptions( const Mocha::StringList& vOptions );

	virtual void setTitle( const Mocha::String& vTitle ) const;

	virtual bool showTitle( ) const;
