...
#ifndef GUI_FLOATATTRIBUTEWIDGET_H
#define GUI_FLOATATTRIBUTEWIDGET_H
...
class FloatAttributeWidget : public EvaluatorAttributeWidget
{
private:
	EvaluatorWidget* mEvaluator;
...
public:
	FloatAttributeWidget( GuiManager* vManager );

	virtual ~FloatAttributeWidget( );
