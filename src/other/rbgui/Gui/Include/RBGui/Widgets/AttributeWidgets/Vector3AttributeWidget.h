...
#ifndef GUI_VEC3ATTRIBUTEWIDGET_H
#define GUI_VEC3ATTRIBUTEWIDGET_H
...
class Vector3AttributeWidget : public EvaluatorAttributeWidget
{
private:
...
public:
	Vector3AttributeWidget( GuiManager* vManager );

	virtual ~Vector3AttributeWidget( );
