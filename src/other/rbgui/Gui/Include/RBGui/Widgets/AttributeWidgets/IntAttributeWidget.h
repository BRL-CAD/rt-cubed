...
#ifndef GUI_INTATTRIBUTEWIDGET_H
#define GUI_INTATTRIBUTEWIDGET_H
...
class IntAttributeWidget : public EvaluatorAttributeWidget
{
private:
...
public:
	IntAttributeWidget( GuiManager* vManager );

	virtual ~IntAttributeWidget( );
