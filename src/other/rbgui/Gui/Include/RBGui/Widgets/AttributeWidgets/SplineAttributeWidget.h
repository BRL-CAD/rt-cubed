...
#ifndef GUI_SPLINEATTRIBUTEWIDGET_H
#define GUI_SPLINEATTRIBUTEWIDGET_H
...
//--------------------------------
class SplineAttributeWidget : public AttributeWidget
{
private:
	SplineWidget* mSpline;

	void splineChanged( GuiElement& vElement, const Mocha::ValueList& vValues );

protected:
	virtual void onRectangleChanged( );

public:
	SplineAttributeWidget( GuiManager* vManager );

	virtual ~SplineAttributeWidget( );
