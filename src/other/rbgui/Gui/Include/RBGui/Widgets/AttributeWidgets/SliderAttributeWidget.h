...
#ifndef GUI_SLIDERATTRIBUTEWIDGET_H
#define GUI_SLIDERATTRIBUTEWIDGET_H
...
//--------------------------------
class SliderAttributeWidget : public EvaluatorAttributeWidget
{
private:
	ScrollWidget* mScroll;

	void scrollChanged( GuiElement& vElement, const Mocha::ValueList& vValues );

protected:
	virtual void onRectangleChanged( );

public:
	SliderAttributeWidget( GuiManager* vManager );

	virtual ~SliderAttributeWidget( );
