...
#ifndef GUI_INPUTDEFINES_H
#define GUI_INPUTDEFINES_H
...
//-----------------------------------------------------------------------
static char getChar( int vKey, int vModifiers )
{
	if ( (vModifiers & KM_SHIFT) || (vModifiers & KM_CAPS) )
	{
		if ( ((vModifiers & KM_SHIFT) && (vModifiers & KM_CAPS)) == false )
		{
			switch ( vKey )
			{
				case KEY_A: return 'A';
...
//-----------------------------------------------------------------------
static char* getKeyName( int vKey )
{
	switch ( vKey )
	{
	case KEY_A: return "a";
	...
	case KEY_LMENU: return "lalt";
	case KEY_RMENU: return "ralt";
