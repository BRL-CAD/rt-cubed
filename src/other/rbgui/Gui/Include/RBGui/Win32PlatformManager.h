...
#ifndef GUI_WIN32PLATFORMMANAGER_H
#define GUI_WIN32PLATFORMMANAGER_H
...
class GUI_EXPORT Win32PlatformManager : public PlatformManager
{
public:
	Win32PlatformManager( );

	virtual ~Win32PlatformManager( );
