...
#ifndef GUI_MACOSPLATFORMMANAGER_H
#define GUI_MACOSPLATFORMMANAGER_H
...
/// MacOS X platform manager
class GUI_EXPORT MacOSPlatformManager : public PlatformManager
{
public:
	MacOSPlatformManager( );

	virtual ~MacOSPlatformManager( );
